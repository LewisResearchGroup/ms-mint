...
def plotly_peak_shapes(
    ...
    :param n_cols: Number of columns for sub-plots, defaults to 1
    :type n_cols: int, optional
    :param peak_labels: List of peak-labels to plot, defaults to None
    :type peak_labels: list or str, optional
    :param legend: Whether or not to add a legend, defaults to True
    :type legend: bool, optional
    :param verbose: Whether or not to be loud, defaults to False
    :type verbose: bool, optional
    :param legend_orientation: Wether or not to show the legend in horizontal ('h') or vertical ('v') format, defaults to "v"
