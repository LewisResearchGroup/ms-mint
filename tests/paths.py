...
TEST_MZXML = os.path.abspath(os.path.join("tests", "data", "ms_files", "test.mzXML"))

TEST_MZML = os.path.abspath(os.path.join("tests", "data", "ms_files", "test.mzML"))
...
TEST_TARGETS_FN = os.path.abspath(
    os.path.join("tests", "data", "targets", "targets_v1.csv")
)
